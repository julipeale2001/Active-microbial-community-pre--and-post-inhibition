...
*Barplot of E. pulchripes faecal pellet bacterial copy numbers for all replicates*
```{r plot all replicate faecal copy numbers by Epibolus, cache=TRUE}
# Barplot for all total copy numbers
ggplot(Epi_Faecal, aes(x = Code, y = `Total Copy Numbers of 16S rRNA`, fill = Treatment, group = Code)) + 
...
ggplot(Epi_Faecal, aes(x = Code, y = `16S rRNA Copies/1 ng DNA`, fill = Treatment, group = Code)) + 
  geom_bar(stat = 'identity', position='dodge') +  xlab("Groups") + scale_y_continuous(label=scientific)

# Barplot for all 16S rRNA Copies/mg sample weight
ggplot(Epi_Faecal, aes(x = Code, y = `16S rRNA Copies/mg sample weight`, fill = Treatment, group = Code)) + 
  geom_bar(stat = 'identity', position='dodge') +  xlab("Groups") + scale_y_continuous(label=scientific)
...
#### Anova tests
**Compare E. pulchripes faecal copy numbers between groups**
...
2. The ANOVA model indicates no significant differences in the 16S rRNA Copies/1 ng DNA.
3. The ANOVA model no significant differences different in the 16S rRNA Copies/mg sample weight.
