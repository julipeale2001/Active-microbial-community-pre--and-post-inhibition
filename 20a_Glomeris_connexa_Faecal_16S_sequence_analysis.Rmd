...
# find Phyla whose rel. abund. is less than 0.5%
Other_phyla <- medians[medians$median <= 0.024, ]$Genus
...
grid.colour = c(Citrobacter  = "#006400", Desulfovibrio  = "#A52A2A", Bacteroides  = "#008080", Alistipes  = "#8A2BE2", Candidatus_Symbiothrix  = "#808000", Candidatus_Methanoplasma = "#00FF00", Pseudomonas = "#00FFFF", Dysgonomonas  = "#FF00FF", Achromobacter  = "#800000", Thauera = "#FF6347", Klebsiella = "#FFFF00", Novosphingobium = "#0000FF", Mycobacterium  = "#808080", `Burkholderia-Caballeronia-Paraburkholderia` = "#87CEFA", Pedobacter = "#2F4F4F", Flavobacterium = "#FF0000", Edaphobaculum = "#E9967A", Rhodanobacter = "#B8860B", Devosia = "#FFD700", Rares = "#C0C0C0")
