...
# Store the result in the list with the treatment names
  ...
  results_list_Glo_hindgut[[result_name]] <- ALDEx2plot_pairwise_Glo_hindgut
}
...
#ALDEX_summary_Glo_hindgut %<>% dplyr::select(Comparison, OTU, diff.btw, diff.win, effect, overlap, baseMean, Significance, Kingdom, Phylum, Class, Order, Family, Genus, Species)
...
ggsave("ANCOM_BC_Fig/ALDEX_Glo_hindgut.svg", width = 40, height = 25, units = "cm")
