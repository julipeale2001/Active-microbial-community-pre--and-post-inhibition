...
```{r t0 CH4 regression model, cache=T}
CH4_model1_d0 <- Epibolus_methane %>% 
  filter(., Day  == 0) %>% lm(`CH4 (nmol mg-1 d-1)` ~ Treatment, .)
print(Anova(CH4_model1_d0, type = "III"))
# checking model assumptions
check_model(CH4_model1_d0)

CH4_emm_mod1_d0 <- emmeans(CH4_model1_d0, as.formula(paste("", "Treatment", sep = " ~ ")), weights = "equal")
      
# Contrasts, pairwise comparisons, tests, and confidence intervals.
CH4_emm_mod_cons1_d0 <- contrast(CH4_emm_mod1_d0, method = "pairwise", adjust = "BH")
print(CH4_emm_mod_cons1_d0)


### Log transformation

Epibolus_methane %<>% 
  mutate(log_CH4 = log2(`CH4 (nmol mg-1 d-1)`))

CH4_model2_d0 <- Epibolus_methane %>% 
                 filter(., Day  == 0) %>% 
                 lm(log_CH4 ~ Treatment,.)
print(Anova(CH4_model2_d0, type = "III"))

# checking model assumptions
check_model(CH4_model2_d0)


CH4_emm_mod2_d0 <- emmeans(CH4_model2_d0, as.formula(paste("", "Treatment", sep = " ~ ")), weights = "equal")
      
# Contrasts, pairwise comparisons, tests, and confidence intervals.
CH4_emm_mod_cons2_d0 <- contrast(CH4_emm_mod2_d0, method = "pairwise", adjust = "BH")
print(CH4_emm_mod_cons2_d0)
```
...
**Building a regression model for day 7**
```{r t7 CH4 regression model, cache=T}
CH4_model1_d7 <- Epibolus_methane %>% 
  filter(., Day  == 7) %>% lm(`CH4 (nmol mg-1 d-1)` ~ Treatment, .)
print(Anova(CH4_model1_d7, type = "III"))
# checking model assumptions
check_model(CH4_model1_d7)

CH4_emm_mod1_d7 <- emmeans(CH4_model1_d7, as.formula(paste("", "Treatment", sep = " ~ ")), weights = "equal")
      
# Contrasts, pairwise comparisons, tests, and confidence intervals.
CH4_emm_mod_cons1_d7 <- contrast(CH4_emm_mod1_d7, method = "pairwise", adjust = "BH")
print(CH4_emm_mod_cons1_d7)
...
CH4_model2_d7 <- Epibolus_methane %>% 
                 filter(., Day  == 7) %>% 
                 lm(log_CH4 ~ Treatment,.)
print(Anova(CH4_model2_d7, type = "III"))

# checking model assumptions
check_model(CH4_model2_d7)


CH4_emm_mod2_d7 <- emmeans(CH4_model2_d7, as.formula(paste("", "Treatment", sep = " ~ ")), weights = "equal")
      
# Contrasts, pairwise comparisons, tests, and confidence intervals.
CH4_emm_mod_cons2_d7 <- contrast(CH4_emm_mod2_d7, method = "pairwise", adjust = "BH")
print(CH4_emm_mod_cons2_d7)
```
...
**Building a regression model for day 14**
```{r t14 CH4 regression model, cache=T}
CH4_model1_d14 <- Epibolus_methane %>% 
  filter(., Day  == 14) %>% lm(`CH4 (nmol mg-1 d-1)` ~ Treatment, .)
print(Anova(CH4_model1_d14, type = "III"))
# checking model assumptions
check_model(CH4_model1_d14)

CH4_emm_mod1_d14 <- emmeans(CH4_model1_d14, as.formula(paste("", "Treatment", sep = " ~ ")), weights = "equal")
      
# Contrasts, pairwise comparisons, tests, and confidence intervals.
CH4_emm_mod_cons1_d14 <- contrast(CH4_emm_mod1_d14, method = "pairwise", adjust = "BH")
print(CH4_emm_mod_cons1_d14)
...
CH4_model2_d14 <- Epibolus_methane %>% 
                 filter(., Day  == 14) %>% 
                 lm(log_CH4 ~ Treatment,.)
print(Anova(CH4_model2_d14, type = "III"))

# checking model assumptions
check_model(CH4_model2_d14)


CH4_emm_mod2_d14 <- emmeans(CH4_model2_d14, as.formula(paste("", "Treatment", sep = " ~ ")), weights = "equal")
      
# Contrasts, pairwise comparisons, tests, and confidence intervals.
CH4_emm_mod_cons2_d14 <- contrast(CH4_emm_mod2_d14, method = "pairwise", adjust = "BH")
print(CH4_emm_mod_cons2_d14)
```
...
**Building a regression model for day 21**
```{r t21 CH4 regression model, cache=T}
CH4_model1_d21 <- Epibolus_methane %>% 
  filter(., Day  == 21) %>% lm(`CH4 (nmol mg-1 d-1)` ~ Treatment, .)
print(Anova(CH4_model1_d21, type = "III"))
# checking model assumptions
check_model(CH4_model1_d21)

CH4_emm_mod1_d21 <- emmeans(CH4_model1_d21, as.formula(paste("", "Treatment", sep = " ~ ")), weights = "equal")
      
# Contrasts, pairwise comparisons, tests, and confidence intervals.
CH4_emm_mod_cons1_d21 <- contrast(CH4_emm_mod1_d21, method = "pairwise", adjust = "BH")
print(CH4_emm_mod_cons1_d21)
...
CH4_model2_d21 <- Epibolus_methane %>% 
                 filter(., Day  == 21) %>% 
                 lm(log_CH4 ~ Treatment,.)
print(Anova(CH4_model2_d21, type = "III"))

# checking model assumptions
check_model(CH4_model2_d21)


CH4_emm_mod2_d21 <- emmeans(CH4_model2_d21, as.formula(paste("", "Treatment", sep = " ~ ")), weights = "equal")
      
# Contrasts, pairwise comparisons, tests, and confidence intervals.
CH4_emm_mod_cons2_d21 <- contrast(CH4_emm_mod2_d21, method = "pairwise", adjust = "BH")
print(CH4_emm_mod_cons2_d21)
```
...
**Building a regression model for day 35**
```{r t35 CH4 regression model, cache=T}
CH4_model1_d35 <- Epibolus_methane %>% 
  filter(., Day  == 35) %>% lm(`CH4 (nmol mg-1 d-1)` ~ Treatment, .)
print(Anova(CH4_model1_d35, type = "III"))
# checking model assumptions
check_model(CH4_model1_d35)

CH4_emm_mod1_d35 <- emmeans(CH4_model1_d35, as.formula(paste("", "Treatment", sep = " ~ ")), weights = "equal")
      
# Contrasts, pairwise comparisons, tests, and confidence intervals.
CH4_emm_mod_cons1_d35 <- contrast(CH4_emm_mod1_d35, method = "pairwise", adjust = "BH")
print(CH4_emm_mod_cons1_d35)
...
CH4_model2_d35 <- Epibolus_methane %>% 
                 filter(., Day  == 35) %>% 
                 lm(log_CH4 ~ Treatment,.)
print(Anova(CH4_model2_d35, type = "III"))

# checking model assumptions
check_model(CH4_model2_d35)


CH4_emm_mod2_d35 <- emmeans(CH4_model2_d35, as.formula(paste("", "Treatment", sep = " ~ ")), weights = "equal")
      
# Contrasts, pairwise comparisons, tests, and confidence intervals.
CH4_emm_mod_cons2_d35 <- contrast(CH4_emm_mod2_d35, method = "pairwise", adjust = "BH")
print(CH4_emm_mod_cons2_d35)
```
...
**Building a regression model for day 63**
```{r t63 CH4 regression model, cache=T}
CH4_model1_d63 <- Epibolus_methane %>% 
  filter(., Day  == 63) %>% lm(`CH4 (nmol mg-1 d-1)` ~ Treatment, .)
print(Anova(CH4_model1_d63, type = "III"))
# checking model assumptions
check_model(CH4_model1_d63)

CH4_emm_mod1_d63 <- emmeans(CH4_model1_d63, as.formula(paste("", "Treatment", sep = " ~ ")), weights = "equal")
      
# Contrasts, pairwise comparisons, tests, and confidence intervals.
CH4_emm_mod_cons1_d63 <- contrast(CH4_emm_mod1_d63, method = "pairwise", adjust = "BH")
print(CH4_emm_mod_cons1_d63)
...
CH4_model2_d63 <- Epibolus_methane %>% 
                 filter(., Day  == 63) %>% 
                 lm(log_CH4 ~ Treatment,.)
print(Anova(CH4_model2_d63, type = "III"))

# checking model assumptions
check_model(CH4_model2_d63)


CH4_emm_mod2_d63 <- emmeans(CH4_model2_d63, as.formula(paste("", "Treatment", sep = " ~ ")), weights = "equal")
      
# Contrasts, pairwise comparisons, tests, and confidence intervals.
CH4_emm_mod_cons2_d63 <- contrast(CH4_emm_mod2_d63, method = "pairwise", adjust = "BH")
print(CH4_emm_mod_cons2_d63)
```
