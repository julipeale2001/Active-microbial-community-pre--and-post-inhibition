...
## **Read the data and create both Globolus (faecal and faecal) phyloseq objects**
...
# Store the result in the list with the treatment names
  ...
  results_list_Glo_faecal[[result_name]] <- ALDEx2plot_pairwise_Glo_faecal
}
...
#ALDEX_summary_Glo_faecal %<>% dplyr::select(Comparison, OTU, diff.btw, diff.win, effect, overlap, baseMean, Significance, Kingdom, Phylum, Class, Order, Family, Genus, Species)


p1_Glo_faecal <- plot_ALDEx_tax(ALDEX_summary_Glo_faecal,
                 OTU_labels = FALSE,
                 sig_level = significance) +
...
ggsave("ANCOM_BC_Fig/ALDEX_Glo_faecal.svg", width = 40, height = 25, units = "cm")
