...
anova(Epi_faecal.ord_pcoa_bray)
anova(Epi_faecal.ord_pcoa_bray, by = "axis")
...
pairwise_adonis(x = t(otu_table(Epi_faecal2)), factor = get_variable(Epi_faecal2, "Treatment"), sim.function = "vegdist", sim.method = "bray",  p.adjust.m = "BH")
```
