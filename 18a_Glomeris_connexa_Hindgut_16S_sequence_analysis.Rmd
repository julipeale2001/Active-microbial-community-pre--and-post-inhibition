...
# find Phyla whose rel. abund. is less than 0.5%
Other_phyla <- medians[medians$median <= 0.005, ]$Genus
...
Glo_hindgut_b <- ggplot(data = Glo_hindgut_glom_rel_DF_2plot, mapping = aes_string(x = "Treatment", y = "Abundance")) + geom_bar(aes(color = Genus, fill  = Genus), stat = "identity", position= "fill") + ylab("Relative Abundance")
Glo_hindgut_b$data$Treatment <- factor(Glo_hindgut_b$data$Treatment, levels = c("Control", "Sterile feed", "Antibiotics (5X)", "Antibiotics (2X)"))
Glo_hindgut_b
```
