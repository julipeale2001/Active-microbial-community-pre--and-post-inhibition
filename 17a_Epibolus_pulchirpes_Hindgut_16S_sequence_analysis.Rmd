...
# find Phyla whose rel. abund. is less than 0.5%
Other_phyla <- medians[medians$median <= 0.009, ]$Genus
...
Epi_hindgut_b <- ggplot(data = Epi_hindgut_glom_rel_DF_2plot, mapping = aes_string(x = "Treatment", y = "Abundance")) + geom_bar(aes(color = Genus, fill  = Genus), stat = "identity", position= "fill") + ylab("Relative Abundance") 
Epi_hindgut_b$data$Treatment <- factor(Epi_hindgut_b$data$Treatment, levels = c("Control", "Sterile feed", "Antibiotics (2X)", "Antibiotics (1X)"))
Epi_hindgut_b
```
